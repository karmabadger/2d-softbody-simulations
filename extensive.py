...
for i in range(20):
    particles.append(p.Particle(2, m=2, r=5.0, pinned=False, height=height))
...
for i in range(20):
    ...
    spring1 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=particles[i], p2=particles[i-1])  # For a more robust spring, set k to a high value


#outline of the shape
outer_particles = particles
