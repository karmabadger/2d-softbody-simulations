...
p1.set_position(0.48, 0.7)
p2.set_position(0.5, 0.7)
p3.set_position(0.5, 0.68)
p4.set_position(0.48, 0.68)
# Set the rest length according to the particle position
spring1.recomputeRestLength()
spring2.recomputeRestLength()
spring3.recomputeRestLength()
spring4.recomputeRestLength()
spring5.recomputeRestLength()
spring6.recomputeRestLength()
