...
p2 = p.Blue(2, m=1000000, r=5.0, pinned=True, height=height)
...
spring2 = s.Spring(dim=2, r=2.5, k=1000,c=100, p1=p1, p2=p3)  # For a more robust spring, set k to a high value
...
p1.set_position(0.4, 0.85)
p2.set_position(0.5, 0.9)
p3.set_position(0.5, 0.8)
