...
p1 = p.Particle(2, m=2, r=5.0, pinned=False, height=height)
p2 = p.Particle(2, m=2, r=5.0, pinned=False, height=height)
p3 = p.Particle(2, m=2, r=5.0, pinned=False, height=height)
p4 = p.Particle(2, m=2, r=5.0, pinned=False, height=height)



spring1 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=p1, p2=p2)  # For a more robust spring, set k to a high value
spring2 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=p2, p2=p3)  # For a more robust spring, set k to a high value
spring3 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=p3, p2=p4)  # For a more robust spring, set k to a high value
spring4 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=p4, p2=p1)  # For a more robust spring, set k to a high value
spring5 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=p1, p2=p3)  # For a more robust spring, set k to a high value
spring6 = s.Spring(dim=2, r=2.5, k=100000, c=100, p1=p2, p2=p4)  # For a more robust spring, set k to a high value

# Set the particles and springs list
particles = [p1, p2, p3, p4]

#outline of the shape
outer_particles = [p1, p2, p3, p4]
springs = [
    spring1,
    spring2,
    spring3,
...
p1.set_position(0.48, 0.9)
p2.set_position(0.5, 0.9)
p3.set_position(0.5, 0.88)
p4.set_position(0.48, 0.88)
